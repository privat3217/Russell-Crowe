...
<head>
  ...
  <title>Russell Crowe VIP Access</title>
...
<body>
  <main class="container">
    ...
    <section class="panel">
      <div class="brand">
        <div class="logo">Russell Crowe VIP</div>
        <div class="tag">Private Access</div>
      </div>

      <h1 class="headline">Where Privilege Meets Precision</h1>
      <p class="lead">
        Russell Crowe VIP is an invitation-only access program designed for individuals who move beyond
    ...
    <section class="panel vip-card">
      ...
      <h2 class="member-name">Barbara Ellen Draper</h2>
